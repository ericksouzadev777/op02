{{-- resources/views/funnel/step6.blade.php --}}
    <!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Etapa 6 – Prêmios PIX</title>
...
<main class="max-w-md mx-auto py-8 px-4">
    <div class="p-6">
        ...
        {{-- barra de progresso (48%) --}}
        <div class="h-2 bg-gray-200 rounded-full overflow-hidden mb-6">
            <div id="progress-bar" class="h-full bg-black" style="width:48%"></div>
        </div>

        {{-- título --}}
        <h1 class="text-center text-2xl font-semibold mb-2">
            Qual desses temas de conteúdo você mais gosta de assistir no Aplicativo?
        </h1>
        ...
        <div class="space-y-3 mb-6">
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-medium">Comédia</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">💃</span>
                    <span class="font-medium">Dança</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-medium">Tutoriais e dicas</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">🎥</span>
                    <span class="font-medium">Vlogs diários</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">💄</span>
                    <span class="font-medium">Moda e beleza</span>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const target      = 131.88; // valor desta etapa
        ...
        // redireciona para step 7
        btnNext.addEventListener('click', () => {
            window.location.href = '{{ url("/funnel/7") }}';
        });
    });
</script>
</body>
