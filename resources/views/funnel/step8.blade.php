{{-- resources/views/funnel/step8.blade.php --}}
    <!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Etapa 8 – Prêmios PIX</title>
...
<main class="max-w-md mx-auto py-8 px-4">
    <div class="p-6">
        ...
        <div class="h-2 bg-gray-200 rounded-full overflow-hidden mb-6">
            <div id="progress-bar" class="h-full bg-black" style="width:64%"></div>
        </div>

        {{-- título --}}
        <h1 class="text-center text-2xl font-semibold mb-2">
            Qual seção do Aplicativo você mais acessa?
        </h1>
        ...
        <div class="space-y-3 mb-6">
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-medium">Para Você</span>
                </div>
                <input type="radio" name="rating" value="para_voce">
            </label>

            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">👥</span>
                    <span class="font-medium">Seguindo</span>
                </div>
                <input type="radio" name="rating" value="seguindo">
            </label>

            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">📺</span>
                    <span class="font-medium">Kwai Live</span>
                </div>
                <input type="radio" name="rating" value="kwai_live">
            </label>

            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">🔍</span>
                    <span class="font-medium">Descobrir</span>
                </div>
                <input type="radio" name="rating" value="descobrir">
            </label>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                ...
                <input type="radio" name="rating" value="outro">
            </label>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const target      = 172.04; // valor desta etapa: 1.037,76 - 865,72
        ...
        // redireciona para step9
        btnNext.addEventListener('click', () => {
            window.location.href = '{{ url("/funnel/9") }}';
        });
    });
</script>
</body>
