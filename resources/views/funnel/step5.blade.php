{{-- resources/views/funnel/step5.blade.php --}}
    <!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Etapa 5 – Prêmios PIX</title>
...
<main class="max-w-md mx-auto py-8 px-4">
    <div class="p-6">
        ...
        <div class="h-2 bg-gray-200 rounded-full overflow-hidden mb-6">
            <div id="progress-bar" class="h-full bg-black" style="width:40%"></div>
        </div>

        {{-- título --}}
        <h1 class="text-center text-2xl font-semibold mb-2">
            O que te faz seguir um criador no Aplicativo?
        </h1>
        ...
        <div class="space-y-3 mb-6">
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-medium">Conteúdo divertido</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">📚</span>
                    <span class="font-medium">Conteúdo educativo</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">🤝</span>
                    <span class="font-medium">Conexão pessoal</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">🔥</span>
                    <span class="font-medium">Participação em desafios</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">📅</span>
                    <span class="font-medium">Frequência de postagens</span>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // redireciona para step 6
        btnNext.addEventListener('click', () => {
            window.location.href = '{{ url("/funnel/6") }}';
        });
    });
</script>
</body>
