{{-- resources/views/funnel/step9.blade.php --}}
    <!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Etapa 9 – Prêmios PIX</title>
...
<main class="max-w-md mx-auto py-8 px-4">
    <div class="p-6 ">
        ...
        <div class="h-2 bg-gray-200 rounded-full overflow-hidden mb-6">
            <div id="progress-bar" class="h-full bg-black" style="width:82%"></div>
        </div>

        {{-- título --}}
        <h1 class="text-center text-2xl font-semibold mb-2">
            Com que frequência você comenta em vídeos do Aplicativo?
        </h1>
        ...
        <div class="space-y-3 mb-6">
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-medium">Sempre</span>
                </div>
                <input type="radio" name="rating" value="sempre">
            </label>
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">📅</span>
                    <span class="font-medium">Frequentemente</span>
                </div>
                <input type="radio" name="rating" value="frequentemente">
            </label>
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">⏳</span>
                    <span class="font-medium">Às vezes</span>
                </div>
                <input type="radio" name="rating" value="as_vezes">
            </label>
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">☔️</span>
                    <span class="font-medium">Raramente</span>
                </div>
                <input type="radio" name="rating" value="raramente">
            </label>
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">🚫</span>
                ...
                <input type="radio" name="rating" value="nunca">
            </label>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // valor incremental desta etapa
        const target      = 117.14; // ex: altere para o valor real
        ...
        btnNext.addEventListener('click', () => {
            window.location.href = '{{ url("/funnel/10") }}';
        });
    });
</script>
</body>
