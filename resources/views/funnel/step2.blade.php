...
<head>
    ...
    <title>Etapa 2 – Prêmios PIX</title>
...
<main class="max-w-md mx-auto py-8 px-4">
    <div class="p-6 ">
        ...
        <h1 class="text-center text-2xl font-semibold mb-2">
            Qual é o seu formato de vídeo favorito no Aplicativo?
        </h1>
        ...
        <div class="space-y-3 mb-6">
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-medium">Vídeo curto</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">📹</span>
                    <span class="font-medium">Vídeo médio</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">⏳</span>
                    <span class="font-medium">Vídeo longo</span>
                </div>
