{{-- resources/views/funnel/step3.blade.php --}}
    <!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Etapa 3 – Prêmios PIX</title>
    ...
    <style>
        ...
        input[type="radio"]:checked::after {
            content: '';
            position: absolute;
            top: 0.125rem;                  /* ajusta verticalmente */
            left: 0.45rem;                  /* ajusta horizontalmente */
            width: 0.25rem;
            height: 0.5rem;
            border: solid #fff;
...
<main class="max-w-md mx-auto py-8 px-4">
    <div class="p-6 ">
        {{-- barra de progresso (24%) --}}
        <div class="h-2 bg-gray-200 rounded-full overflow-hidden mb-6">
            <div id="progress-bar" class="h-full bg-black" style="width:24%"></div>
        </div>

        {{-- pergunta --}}
        <h1 class="text-center text-2xl font-semibold mb-2">
            Como você descobre novos vídeos no Aplicativo?
        </h1>
        ...
        <div class="space-y-3 mb-6">
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-medium">Feed “Para você”</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">👤</span>
                    <span class="font-medium">Seguindo criadores</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">🔍</span>
                    <span class="font-medium">Através de hashtags</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">📜</span>
                    <span class="font-medium">Feed “Seguindo”</span>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        btnNext.addEventListener('click', () => {
            window.location.href = '{{ url("/funnel/4") }}';
        });
    });
</script>
</body>
