{{-- resources/views/funnel/step1.blade.php --}}
    <!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Etapa 1 – Prêmios PIX</title>
...
<nav class="bg-white border-b border-gray-200">
    <div class="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
        {{-- logo --}}
        <img src="{{ asset('images/img-original.png') }}" class="h-20" alt="Prêmios PIX">
        {{-- controles à direita --}}
...
<main class="max-w-md mx-auto py-8 px-4">
    ...
    <div class="p-6">
        ...
        <div class="h-2 bg-gray-200 rounded-full overflow-hidden mb-6">
            <div id="progress-bar" class="h-full bg-black" style="width:8%"></div>
        </div>
        ...
        <div class="space-y-3 mb-6">
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                ...
                <input type="radio" name="rating" value="1"
                       class="h-5 w-5 border-2 border-gray-300 accent-black rounded-none">
            </label>
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">😊</span>
                    <span class="font-medium">Boa</span>
                </div>
            ...
            <label class="flex justify-between items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    <span class="text-2xl">😒</span>
                    <span class="font-medium">Ruim</span>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        btnContinue.addEventListener('click', () => {
            ...
            // anima número de 0 até target dentro do modal
        ...
        btnNext.addEventListener('click', () => {
            window.location.href = '{{ url("/funnel/2") }}';
        });
    });
</script>
</body>
